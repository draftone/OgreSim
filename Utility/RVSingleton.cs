...
namespace RV
{
    ...
    /// SingletonパターンClass
    /// </summary>
    public class RVSingleton<T> : RVMonoBehaviour where T : MonoBehaviour
    {
        ...
        protected RVSingleton(bool persistent, bool automatic)
        {
            RVSingleton<T>.persistent = persistent;
            RVSingleton<T>.automatic = automatic;
        }
    }
}